def SaveTriggers(data_folder1,Tmin, Tmax, Bin_Lengths):
    ...
    data_folder = 'C:/Users/ASMLabUser1/Desktop/SAZA_2018_1/%s/FishData' % data_folder1
...
SaveTriggers('test',0,1000,Bin_Lengths=['0-1000', '1000-2000', '2000-3000', '3000-5000','5000-8000','8000-11000', '11000-15000', '15000-20000'])
